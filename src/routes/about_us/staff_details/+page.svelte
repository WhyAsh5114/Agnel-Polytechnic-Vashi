<script lang="ts">
	...
	let electronics_telecommunication_teaching_staff = [
		...
		['Mr. Mohd Janisar', 'Lecturer', ['M.Tech  (Pursuing)', 'Computer Engineering'], 'AdHoc', '02/07/2025', '3 years']
	];
	...
	let Artificial_Intelligence_Machine_Learning_teaching_staff = [
		...
		['Mr. Pranavkumar Bhadane', 'Lecturer', ['M.E Computer '], '14/02/2022', '12 years'],
		['Mrs. Ashwini Baviskar', 'Lecturer', ['B.E IT'], '01/02/2023', '3 years'], 
		['Mrs. Samina Siddique', 'Lecturer', ['M.Tech Computer (Pursuing)'], '01/09/2023', '11 years'],
	...
	let humanities_department = [
		...
		['Ms. Roopa Shetty', 'Lecturer', ['Masters in Arts', 'English'], '18/06/1996', '29 years'],
		...
		['Ms. Susan Sabu Manimala', 'Lecturer', ['BE in EXTC, MA in English Literature'], '01/06/2024', '5 years']
	];
