...
<div class="flex justify-center px-4 md:px-8 py-10 bg-gray-100">
  <div class="bg-white max-w-5xl w-full shadow-lg rounded-xl p-6 md:p-10">
    ...
    <div class="space-y-6 text-gray-800 leading-relaxed text-justify">
      ...
      <section>
        <h3 class="font-bold text-lg mb-2">1. Applicability and Scope</h3>
        <p>
      ...
      <section>
        <h3 class="font-bold text-lg mb-2">2. Information We Collect</h3>
        <p>
      ...
      <section>
        <h3 class="font-bold text-lg mb-2">3. How We Use Your Information</h3>
        <p>
      ...
      <section>
        <h3 class="font-bold text-lg mb-2">4. Data Sharing and Disclosure</h3>
        <p>
      ...
      <section>
        <h3 class="font-bold text-lg mb-2">5. Data Retention</h3>
        <p>
      ...
      <section>
        <h3 class="font-bold text-lg mb-2">6. Children’s Privacy</h3>
        <p>
      ...
      <section>
        <h3 class="font-bold text-lg mb-2">7. Data Security</h3>
        <p>
      ...
      <section>
        <h3 class="font-bold text-lg mb-2">8. User Rights</h3>
        <p>
      ...
      <section>
        <h3 class="font-bold text-lg mb-2">9. Third-Party Services and Links</h3>
        <p>
      ...
      <section>
        <h3 class="font-bold text-lg mb-2">10. Policy Updates</h3>
        <p>
      ...
      <section>
        <h3 class="font-bold text-lg mb-2">11. Contact Information</h3>
        <p>
